...
export default function App() {
  ...
  const openNew = (dueDate?: string | null) => {
    setModalTask(newTask(dueDate ?? null));
    setIsNewTask(true);
  };
  ...
  const handleModalSave = (updated: Task) => {
    if (isNewTask) addTask(updated);
    else updateTask(updated);
    setModalTask(null);
  };
